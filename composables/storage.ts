...
const documentPathAssembler = (bucketName: string, documentName: string) => `${bucketName}.${documentName}`;
...
export function createOrSetDocument(bucketName: string, documentName: string, documentContents: any) {
...
export function getOrDefaultDocument(bucketName: string, documentName: string, contents: any): any {
    try {
...
export function deleteDocument(bucketName: string, documentName: string){
    ...
    bucketIndex.bucketPaths.splice(bucketIndex.bucketPaths.findIndex((e) => e == documentPath), 1);
