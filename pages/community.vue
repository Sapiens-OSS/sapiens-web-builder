      ...
      >
        <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
          ...
          <p class="mt-6 text-xl leading-8 text-zinc-400">
            Sapiens OSS is a friendly, open community dedicated to building mods
            and related tools for Sapiens.
          </p>
        ...
        >
          ...
          >
            ...
            >
              <img
                src="@/assets/img/tapir_stock.png"
                alt=""
