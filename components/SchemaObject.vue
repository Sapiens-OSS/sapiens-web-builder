<template>
  <Disclosure as="div" v-slot="{ open }">
    <dt class="inline-flex w-full rounded-lg overflow-hidden bg-zinc-800/60">
      <DisclosureButton
    ...
    <DisclosurePanel as="dd" class="mt-2 pl-2 lg:pl-4 space-y-2">
      <SchemaSelector
...
const props = defineProps(["schema", "modelValue", "elementConfig"]);
