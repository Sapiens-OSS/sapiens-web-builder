                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4"
                            ...
                            <div class="mt-1 sm:col-span-2 sm:mt-0">
                                <div class="flex max-w-lg rounded-md shadow-sm">
                                    <input type="text" :name="entry[0]" :id="entry[0]"
                                        ...
                                        class="block w-full min-w-0 flex-1 rounded-md background-tinted text-tinted border-gray-300 dark:border-slate-500 focus:border-slate-500 focus:ring-slate-500 sm:text-sm" />
                                </div>
                            </div>
                        </div>
                        <div class="mt-1 sm:col-span-2 sm:mt-0" v-else-if="entry[1].type == 'long'">
                            <textarea :id="entry[0]" :name="entry[0]" rows="3" :placeholder="entry[1].placeholder"
                                ...
                                class="block w-full max-w-lg rounded-md background-tinted text-tinted border-gray-300 dark:border-slate-500 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:text-sm" />
                        </div>
                        <div class="mt-1 sm:col-span-2 sm:mt-0" v-else-if="entry[1].type == 'options'">
                            <select id="country" name="country" autocomplete="country-name"
                                v-model="mod[props.page][entry[0]]"
                                class="block w-full max-w-lg rounded-md background-tinted border-gray-300 dark:border-slate-500 shadow-sm focus:border-slate-500 focus:ring-slate-500 sm:max-w-xs sm:text-sm">
