<template>
  <div>
    <label
      ...
      class="block text-sm font-medium leading-6 text-white text-white"
    ...
    <div class="mt-1">
      ...
      <input
        ...
        v-model="text"
        class="block w-full rounded-md border-0 py-1.5 text-white shadow-sm placeholder:text-zinc-400 focus:ring-2 focus:ring-inset focus:ring-amber-600 sm:text-sm sm:leading-6 bg-zinc-800 text-white"
        :placeholder="
